...
def roll_dice(num_rolls, dice=six_sided):
    ...
    score = 0
    is_one = 0 
    def is_dice_equal_one(dice):
        return dice == 1
    for i in range(num_rolls):
        d = dice()
        if is_dice_equal_one(d):
            is_one = 1
        score += d
    if is_one:
        score = 1
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    # for returning say function later with updating information for each turn 
    next_say = say
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    "*** YOUR CODE HERE ***"
    def say(score0, score1):
        # solution 1: create new variable to hold parent's local var value, for later calculations.
        ...
        #     if diff > highest:
        #         highest = diff
        #         print(f"{diff} point(s)! The most yet for Player 1")
        # else:
        #     diff = (score0 - last_score)
        #     track_ls = score0
        #     if diff > highest:
        #         highest = diff
        #         print(f"{diff} point(s)! The most yet for Player 0")
        # return announce_highest(who, track_ls, highest)

        # solution 2: not using assignment statements at all. Instead, 
        # pass new values in as arguments to a call to announce_highest.
        if who:
            diff = (score1 - last_score)
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    while i <= 10:
        ...
        if average_score > higher_average:
            higher_average = average_score
            min_num_roll = i
        i += 1    
    return min_num_roll
    # END PROBLEM 9
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    score = score + free_bacon(opponent_score) # score after rolling zero dice
